...
dados1 = pd.read_excel('/home/amarques/gdrive/DataScience/documents/desenvolvimento/fenix/tratamento/BASEJATAI.xlsx', sheet_name="BASE DE DADOS JATAÍ")

dados2 = pd.read_excel('/home/amarques/gdrive/DataScience/documents/desenvolvimento/fenix/tratamento/BaseCliente.xlsx')
...
x=dados_com_dummy[['score','chan
ce_de_pagamento', # soma_total é o valor da parcela
                    'risco_de_inadimplencia',
                    'capacidade_mensal_de_pagamento',
                    'comprometimento_mensal_estimado',
                    'renda_estimada'
